<template>
    <main class="privacy">
        <header class="header">
            <router-link tag="div" to="/" class="header__home">
                <i class="material-icons-outlined">home</i>
            </router-link>
            <h1 class="header__headline">Impressum</h1>
        </header>
        <div class="loading-box">
            <h3>Angaben gemäß § 5 TMG</h3>
            <p>Michael Scheurich<br>Zollhausweg 55<br>73734 Esslingen</p>
            <h4>Vertreten durch:</h4>
            <p>Michael Scheurich</p>
            <h4>Kontakt:</h4>
            <p>Michael Scheurich<br>E-Mail: contact@hitro.app</p>
